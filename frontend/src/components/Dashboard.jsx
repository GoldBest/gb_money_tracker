  ...
  if (loading) {
    return (
      <div className="loading">
        <AppleSkeletonBalance />
        <AppleSkeletonStats count={4} />
        <AppleSkeletonTransactions count={3} />
      </div>
    )
  }
        ...
        <div className="empty-state">
          <AppleFadeIn delay={100}>
            <div className="apple-card large text-center">
              ...
              <NewAppleStaggeredList staggerDelay={0.2}>
                <AppleCard variant="outlined" size="small" className="text-center">
                  <div className="mb-2">
  ...
  return (
    <PullToRefresh onRefresh={loadStats}>
      <div className="dashboard">
        ...
        {/* Stats Grid */}
        <NewAppleStaggeredList staggerDelay={0.1}>
          <AppleCard variant="elevated" size="small" className="stat-card">
